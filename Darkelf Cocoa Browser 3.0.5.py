...
class Browser(NSObject):
    ...
    def _new_wk(self) -> WKWebView:
        ...
        # --- Inject main defense scripts (letterboxing, WebRTC, etc.) ---
        try:
    ...
    def _rebuild_active_webview(self):
            ...
            try:
                ...
                # (optional but nice) keep these if you use them elsewhere
                ...
                # Make sure it resizes like the old view did
                try:
                ...
                # Ensure your content scripts are injected into the rebuilt view
                try:
                    self._inject_core_scripts(wk)   # if you have this helper defined
                except Exception:
                    pass
            ...
            try:
                # Prefer the old webview's actual URL if available
                old_url = ""
                try:
                    u = old.URL()
                    if u:

...
from Foundation import NSURL, NSURLRequest, NSMakeRect, NSNotificationCenter, NSDate, NSTimer
from AppKit import NSImageSymbolConfiguration, NSBezierPath, NSFont, NSAttributedString, NSAlert, NSAlertStyleCritical, NSObject
...
class _NavDelegate(NSObject):
    ...
    def webView_decidePolicyForNavigationAction_decisionHandler_(self, webView, navAction, decisionHandler):
        try:
            ...
            # Only block plaintext HTTP if Tor is OFF (no .onion logic)
...
class Browser(NSObject):
    ...
    def _new_wk(self) -> WKWebView:
        ...
        try:
            ...
            print("[Debug] App-bound domain setting failed:", e)
    ...
    def _rebuild_active_webview(self):
        ...
        try:
            ...
            print("[WK] delegate setup failed:", e)
            self._nav_delegate = None

        # --- Create & mount the new WKWebView ---
        try:
        ...
        if url in (None, "", "about:home", "about:blank", "about:blank#blocked", "about://home"):
            base_url = NSURL.URLWithString_("https://lite.duckduckgo.com/")
            wk.loadHTMLString_baseURL_(HOMEPAGE_HTML, base_url)
